...
```bash
curl -s https://YOUR-URL.vercel.app/ -o /tmp/home.html && wc -c /tmp/home.html
```
...
- [ ] It prints at least one of those section names.
...
```bash
curl -s -o /dev/null -w "%{http_code}\n" https://YOUR-URL.vercel.app/assets/Du.webp
```
...
- [ ] It prints `200` (any route falls back to the server render).

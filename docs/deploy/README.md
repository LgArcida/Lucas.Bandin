...
| 6 | [`06-add-custom-domain.md`](06-add-custom-domain.md) | Tell Vercel about your domain and prove you own it |
| 7 | [`07-configure-cloudflare-dns.md`](07-configure-cloudflare-dns.md) | Point your Cloudflare DNS at Vercel |
| 8 | [`08-final-checks.md`](08-final-checks.md) | Canonical redirect + launch checklist |

## Before you start

- [ ] Replace every **`yourdomain.com`** in these docs with your real domain.
